 ...
 * Autor: Miguel Angel Rueda Aguilar
 * Fecha: 29-08-2018
 * Descripción: Metodos para la implementacion generica de salida y representacion de errores 
 */
...
* Parámetros:
*	Entrada: 
*				$msglog : mensaje que se almacenara en el log de errores
...
*/
    ...
    public static function system_error($msglog = NULL, $msgoutput = NULL, $httpcode = NULL){
        ...
        $_msg = $msgoutput ? $msgoutput : ($msglog ? $msglog : "Ocurrió un error con el servicio, favor de contactár al administrador...!!!") ;
